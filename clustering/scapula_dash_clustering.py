...
def np_image_to_base64(scapula_dataset,slice_x,slice_y,slice_z):
    im_x = Image.fromarray(np.pad(scapula_dataset[slice_x,:,:],((22,21),(0,0)))*255)
    im_y = Image.fromarray(scapula_dataset[:,slice_y,:]*255)
    im_z = Image.fromarray(np.pad(scapula_dataset[:,:,slice_z],((0,0),(152,151)))*255)
...
if __name__=="__main__":
    ...
    with open("scap_pos_array_hor_all.pkl","rb") as f1:
    ...
    app.run(jupyter_mode="external",host="0.0.0.0",port="22")
